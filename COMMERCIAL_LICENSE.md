# Commercial License — GhostSearch
...
> Replaces: Algolia ($50K+/year enterprise), Elasticsearch (infra + ops cost), Typesense, Meilisearch.
> GhostSearch runs entirely in the browser — zero server, zero API calls, sub-millisecond results.

## Pricing

| Tier | Price | What You Get |
|:-----|:------|:-------------|
| **Indie** | $299/year | 1 developer, 1 application, up to 50,000 indexed documents |
| **Startup** | $1,999/year | Up to 10 developers, 3 applications, up to 500,000 documents |
| **Enterprise** | $9,999/year | Unlimited developers, unlimited apps, unlimited documents, priority support |
| **Platform / OEM** | $19,999/year | White-label rights, embed in your product |
| **Full IP Buyout** | $750,000 | Complete intellectual property transfer |

### Why This Pricing?

Algolia charges $0.50–$0.75 per 1K search requests. At 10M requests/month:
- **Algolia**: $5,000–$7,500/month ($60K–$90K/year)
- **GhostSearch Enterprise**: $9,999/**year** (saving $50K–$80K/year)
